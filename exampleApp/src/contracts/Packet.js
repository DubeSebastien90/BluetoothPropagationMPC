 ...
 * @property {'msg'|'contact_req'|'contact_ack'|'location'|'meetingpoint'|'arrival'} type - Packet purpose. Defaults to 'msg'.
...
export function createPacket({ from, fromId, to, toId, body, type = 'msg', groupId = null }) {
  return {
